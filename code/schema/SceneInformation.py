...
class SceneBackground(BaseModel):
    ...
    description: str = Field(title="background_description",
                            description="The description of the scene.",
                            examples= ["你来到隔壁老王的烧饼铺，蒸笼冒着热气却未见武大郎的摊位."])

class SceneCharacter(BaseModel):
    name: str = Field(title="character_name", 
                      description="The name of the character.", 
                      examples=["老王"])
    description: str = Field(title="character_description", 
                             description="The description of the character.", 
                             examples=["隔壁老王四十余岁，满脸横肉，手臂有烫伤疤痕。因摊位纠纷与武大郎积怨已久，近日正在争夺早市黄金摊位."])
